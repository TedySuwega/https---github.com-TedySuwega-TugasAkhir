...
n_input = 3000       # MNIST data input (img shape : 28*28)
...
for epoch in range(training_epochs):
    ...
    _, c = sess.run([optimizer, cost], feed_dict={X: test.a})
...
# encode_decode = sess.run(y_pred, feed_dict={X: Load_Data.fix)
#
# # Compare original images with their recontructions
